...
namespace Car_Rental.Data.Migrations
{
    ...
    [Migration("20260422133836_FixBookingCascadePaths")]
    partial class FixBookingCascadePaths
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Car_Rental.Models.Owner", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Car_Rental.Models.Renter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Car_Rental.Models.Booking", b =>
                {
                    b.HasOne("Car_Rental.Models.Renter", "Renter")
                        .WithMany()
            ...
            modelBuilder.Entity("Car_Rental.Models.Vehicle", b =>
                {
                    b.HasOne("Car_Rental.Models.Owner", "Owner")
                        .WithMany("Vehicles")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Car_Rental.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

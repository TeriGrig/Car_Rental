...
namespace Car_Rental.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                if (Input.BirthYear == null || Input.LicenceYear == null)
                {
                    ModelState.AddModelError(string.Empty, "Birth Year and Licence Year are required for renters.");
                    return Page();
                }

                if (DateTime.Now.Year - Input.BirthYear < 18)
                {
            ...
            if (result.Succeeded)
            {
                ...
                else if (Input.Role == "Renter")
                {
                    ...
                    var renter = new Renter
                    {
                        ...
                        LicenceYear = Input.LicenceYear.Value
                    };
